...
export function connectAdv<IStateProps, IDispatchProps>(
    ...
    mapDispatch?: (dispatch: Dispatch, ownProps: any) => IDispatchProps,
    options?: Options<IAppState, IStateProps, any, IReduxProps<IStateProps, IDispatchProps>>,
): any {
    return connect(mapState, mapDispatch as any, merge, options) as any;
}
